...
#undef TC_IOT_CONFIG_AUTH_MODE
#define TC_IOT_CONFIG_AUTH_MODE   1
#endif

#ifdef PKG_USING_TENCENT_IOTKIT_IS_SING
#undef TC_IOT_CONFIG_AUTH_MODE
...
/* ����������Ҫ���ڹ���������Ʒ���豸��Ȼ���ȡ�����Ϣ����*/
/* MQ�����ַ�������ڲ�Ʒ��������Ϣ��->��mqtt���ӵ�ַ��λ���ҵ���*/
#define TC_IOT_CONFIG_MQ_SERVER_HOST "mqtt-m1j432sw.ap-guangzhou.mqtt.tencentcloudmq.com"
...
#define TC_IOT_CONFIG_COAP_DEVICE_CLIENT_ID TC_IOT_CONFIG_DEVICE_PRODUCT_KEY "@" TC_IOT_CONFIG_DEVICE_NAME
